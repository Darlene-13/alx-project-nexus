...
def movie_hub(request):
    ...
    endpoints_by_section = {
        "🎬 MOVIES": [
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/",                  "description": "List all movies",       "status": "✅ Active"},
            {"method": "POST",   "url": "/movies/api/v1/api/v1/movies/",                  "description": "Create a new movie",     "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/{pk}/",            "description": "Retrieve movie details", "status": "✅ Active"},
            {"method": "PUT",    "url": "/movies/api/v1/api/v1/movies/{pk}/",            "description": "Update movie",           "status": "✅ Active"},
            {"method": "PATCH",  "url": "/movies/api/v1/api/v1/movies/{pk}/",            "description": "Partial update",         "status": "✅ Active"},
            {"method": "DELETE", "url": "/movies/api/v1/api/v1/movies/{pk}/",            "description": "Delete movie",           "status": "✅ Active"},
        ],
        "🎯 MOVIE CUSTOM ACTIONS": [
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/popular/",                     "description": "Popular movies",       "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/top_rated/",                   "description": "Top-rated movies",     "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/recent/",                      "description": "Recently released",    "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/by_genre/?genre=Action",       "description": "Movies by genre",      "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/stats/",                       "description": "Movie stats",          "status": "✅ Active"},
            {"method": "POST",   "url": "/movies/api/v1/api/v1/movies/{pk}/increment_views/",        "description": "Increment views",      "status": "✅ Active"},
            {"method": "POST",   "url": "/movies/api/v1/api/v1/movies/{pk}/increment_likes/",        "description": "Increment likes",      "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/movies/{pk}/similar/",                "description": "Similar movies",       "status": "✅ Active"},
        ],
        "📚 GENRES": [
            {"method": "GET",    "url": "/movies/api/v1/api/v1/genres/",                  "description": "List genres",             "status": "✅ Active"},
            {"method": "POST",   "url": "/movies/api/v1/api/v1/genres/",                  "description": "Create genre",            "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/genres/{pk}/",            "description": "Genre details",           "status": "✅ Active"},
            {"method": "PUT",    "url": "/movies/api/v1/api/v1/genres/{pk}/",            "description": "Update genre",            "status": "✅ Active"},
            {"method": "PATCH",  "url": "/movies/api/v1/api/v1/genres/{pk}/",            "description": "Partial update",          "status": "✅ Active"},
            {"method": "DELETE", "url": "/movies/api/v1/api/v1/genres/{pk}/",            "description": "Delete genre",            "status": "✅ Active"},
            {"method": "GET",    "url": "/movies/api/v1/api/v1/genres/{pk}/movies/",     "description": "Movies in genre",         "status": "✅ Active"},
        ],
        "🔎 SEARCH & RECOMMENDATIONS": [
            {"method": "GET", "url": "/movies/api/v1/api/v1/search/?q=batman",             "description": "Advanced search",         "status": "✅ Active"},
            {"method": "GET", "url": "/movies/api/v1/api/v1/recommendations/?type=popular","description": "Recommendations",         "status": "✅ Active"},
        ],
        "📊 ANALYTICS": [
            {"method": "GET", "url": "/movies/api/v1/api/v1/analytics/",                  "description": "Analytics overview",      "status": "✅ Active"},
        ],
        "📘 API DOCUMENTATION": [
            {"method": "GET", "url": "/api/v1/movies/docs/",   "description": "Swagger UI",   "status": "✅ Active"},
            {"method": "GET", "url": "/api/v1/movies/redoc/",  "description": "ReDoc UI",      "status": "✅ Active"},
            {"method": "GET", "url": "/api/v1/movies/schema/", "description": "Schema (JSON)", "status": "✅ Active"},
        ],
    }
