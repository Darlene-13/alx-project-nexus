...
recommendation_experiments {
    ...
    target_metric: varchar(50) NOT NULL -- 'ctr', 'engagement', 'retention', 'conversion'
    minimum_sample_size: integer DEFAULT 1000
    confidence_level: float DEFAULT 0.95
    
    -- Results (Updated by analytics)
